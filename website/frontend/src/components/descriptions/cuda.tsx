      ...
      <div style={{ padding: '0px 40px 0px 40px', fontFamily: 'var(--serious-font-family)' }} id="cuda-details">
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ width: '100%', paddingRight: '10px' }}>
            <h3 style={{fontSize: '1.2rem', fontWeight: 'bold'}}>Current Work</h3>
            <ul style={{ paddingLeft: '20px' }}>
              <li style={{ marginTop: '1rem' }}>Created a batched Flash Attention 2 kernel in CUDA supporting MHA Transformers! <b>Here are the Technical Details:</b>
                <ul style={{ paddingLeft: '20px' }}>
                  ...
                  <li style={{ marginTop: '0.25rem' }}>Prioritized using cheaper <b>warp level arithmetics</b> over <b>atomic operations</b> for inter-thread operations (particularly for online softmax)</li>
        ...
        <div style={{ width: '100%'}}>
          <h3 style={{fontSize: '1.2rem', fontWeight: 'bold', marginTop: '1rem'}}>Future Work</h3>
            <ul style = {{ paddingLeft: '20px'}}>
