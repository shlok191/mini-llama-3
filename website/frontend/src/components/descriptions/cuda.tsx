            ...
            <ul style={{ paddingLeft: '20px', fontSize: '18px'}}>
              <li style={{ marginTop: '1rem' }}>Created a batched Flash Attention 2 kernel in CUDA supporting MHA Transformers! <b>Here are the Technical Details:</b>
                <ul style={{ paddingLeft: '20px'}}>
                  ...
                  <li style={{ marginTop: '0.25rem' }}>Efficiently used <b>96 KB of available 100 KB</b> of shared memory per SM by tiling <b>32 Q rows</b> and <b>16 K, V columns</b> every iteration</li>
                  <li style={{ marginTop: '0.25rem' }}>Carefully analyzed kernel structure to deduce where <b>cheaper warp synchronizations</b> can replace costlier block synchronization calls!</li>
              ...
              <li style={{ marginTop: '1rem' }}>I also wrote a <b>Rust Tokenizer</b> trained using <b>Byte-Pair Encoding</b> to familiarize myself with the Rust language :)</li>
            </ul>
          </div>
        </div>
        ...
        <div style={{ width: '100%'}}>
          <h3 style={{fontSize: '1.5rem', fontWeight: 'bold', marginTop: '1rem'}}>Future Work</h3>
            <ul style = {{ paddingLeft: '20px', fontSize: '18px'}}>
              ...
              <li style={{ marginTop: '0.25rem'}}>Implementing Brain Float 16 (BFloat16) support to improve training speed</li>
              <li style={{ marginTop: '0.25rem'}}>Performing instruction finetuning to garner a more organic conversation between the user and the model</li>
              <li style={{ marginTop: '0.25rem'}}>Train the model on the &lt;end-of-sequence&gt; tokens to allow for a natural end to responses! </li>
